...
;( function( $, window, undefined ) {
	...
	$.Flipshow.prototype = {
		...
		_addNav : function() {
			...
			var self = this,
				$navLeft = $( '<div class="fc-left"><span id="uno">Psicomotrocidad</span><span id="dos">Toma de decisiones</span><span id="tres">Descubrir</span><i class="icon-arrow-left"></i></div>' ),
